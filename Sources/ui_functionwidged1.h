...
public:
    ...
    void setupUi(QDialog *FunctionWidged)
    {
        ...
        layoutWidget_2->setGeometry(QRect(370, 350, 261, 31));
        ...
        checkBox->setGeometry(QRect(20, 110, 70, 17));

        verticalLayout_5->addWidget(widget);

        checkBox_FunctionReference = new QCheckBox(groupBox);
        ...
        verticalLayout_5->addWidget(checkBox_FunctionReference);
    ...
    void retranslateUi(QDialog *FunctionWidged)
    {
        ...
        checkBox->setText(QApplication::translate("FunctionWidged", "CheckBox", Q_NULLPTR));
