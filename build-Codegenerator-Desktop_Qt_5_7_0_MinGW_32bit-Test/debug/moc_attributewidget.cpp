...
QT_MOC_LITERAL(7, 151, 38) // "on_checkBox_AttributeReferenc..."
    ...
    "on_checkBox_AttributeReference_clicked"
};
...
const QMetaObject AttributeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AttributeWidget.data,
      qt_meta_data_AttributeWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AttributeWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IWidget"))
        return static_cast< IWidget*>(const_cast< AttributeWidget*>(this));
